...
public class freeRoomList extends AppCompatActivity {
    FirebaseDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_room_list);
    ...
    public void bookRoomActivity(final int pos) {
        ...
        Intent i =new Intent(this,bookRoom.class);
